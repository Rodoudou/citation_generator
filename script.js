...
//console.log(citation,auteur,newCitation);

const actionNewCitation =()=>{
    do{
       citation.textContent=citations[nombreAleatoire(6)][0];
       auteur.textContent=citations[nombreAleatoire(6)][1];
        
    //console.log("citations[nombreAleatoire(6)]", citations[nombreAleatoire(6)]);
    }while(nombreAleatoire == dernier);
};

    const btnNewCitation = newCitation.addEventListener('click',actionNewCitation);
